...
# GET /reviews/new
  ...
  def create
    ...
    respond_to do |format|
      if @review.save
        format.html { redirect_to @resturant, notice: 'Review was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @review.update(review_params)
        format.html { redirect_to resturant_path(@resturant), notice: 'Review was successfully updated.' }
